...
class PasswordRestoreView(PasswordResetView):
    template_name = 'users/restor.html'
...
class UserLoginView(LoginView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Dark horse - Авторизация'
        return context
...
class UserRegistrationView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Dark horse - Регистрация'
        return context
...
class UserProfileView(LoginRequiredMixin, CacheMixin , UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Dark horse - Кабинет'
...
class UserCartView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Dark horse - Корзина'
        return context
